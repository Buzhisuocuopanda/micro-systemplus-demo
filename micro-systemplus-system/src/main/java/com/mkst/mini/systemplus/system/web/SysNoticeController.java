...
public class SysNoticeController extends BaseController
{
     ...
     * 上传图片
     */
    @PostMapping( "/uploadNoticeImg")
    @ResponseBody
    public String uploadNoticeImg(@RequestParam("file") MultipartFile file){
        String noticeImage = "";
        try{
            if (!file.isEmpty()){
                noticeImage = FileUploadUtils.upload(Global.getDownloadPath(), file);
            }
        }
        catch (Exception e){
            e.printStackTrace();
