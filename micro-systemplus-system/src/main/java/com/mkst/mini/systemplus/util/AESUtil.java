...
public class AESUtil {
    ...
    public static void main(String[] arg) {
        ...
        String str =encyrpt("123456");
        System.out.println("123456加密后："+ str);
        System.out.println("123456解密后："+ decrypt(str));
...
/*
        ...
        byte[] encodedText = AesEcbEncode("SSS".getBytes(), key);
        
        String kk = Base64.encodeBase64String(encodedText);
        
        System.out.println("AES ECB encoded with Base64: " + kk);
        
        
        System.out.println("AES ECB decoded: " + AesEcbDecode(Base64.decodeBase64(kk) ,key));
        ...
        *//*encodedText = AesCbcEncode(PLAIN_TEXT.getBytes(), key, IVPARAMETERS);
        ...
        System.out.println("CBC加密前"+Base64.encodeBase64String(encodedText));
        System.out.println("AES CBC decoded: " + AesCbcDecode(encodedText, key, IVPARAMETERS));*/
    }
