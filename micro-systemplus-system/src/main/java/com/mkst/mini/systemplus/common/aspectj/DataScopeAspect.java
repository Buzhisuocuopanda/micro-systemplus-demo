...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.mkst.mini.systemplus.common.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint)
    {
        ...
        if (currentUser != null)
        {
            ...
            {
                dataScopeFilter(joinPoint, currentUser, controllerDataScope.tableAlias(),controllerDataScope.userAlias());
            }
        }
    }
