package com.mkst.mini.systemplus.common.shiro.realm;

import com.mkst.mini.systemplus.common.shiro.service.SysLoginService;
...
public class UserRealm extends AuthorizingRealm
{
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0)
    {
        ...
        {
            roles = roleService.selectRoleKeys(Convert.toLong(user.getUserId()));
            menus = menuService.selectPermsByUserId(Convert.toLong(user.getUserId()));
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException
    {
        ...
        try
        {
            if(!upToken.getType().equals(LoginType.PASSWORD)){
                user = loginService.loginNoPassword(username,upToken.getType());
            }else {
