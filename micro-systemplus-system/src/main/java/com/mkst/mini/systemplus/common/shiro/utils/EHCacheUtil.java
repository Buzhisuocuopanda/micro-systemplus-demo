...
public class EHCacheUtil {
	...
	public static Cache initCache(String cacheName, long timeToLiveSeconds) throws Exception {
		return EHCacheUtil.initCache(cacheName, NewEHCacheConfig.MAXELEMENTSINMEMORY, NewEHCacheConfig.OVERFLOWTODISK,
				NewEHCacheConfig.ETERNAL, timeToLiveSeconds, NewEHCacheConfig.TIMETOIDLESECONDS);
	}
	...
	public static Cache initMyCache(String cacheName) throws Exception {
		return EHCacheUtil.initCache(cacheName, NewEHCacheConfig.TIMETOlIVESECONDS);
	}
	...
	public static boolean setValue(String cacheName, String key, Object value, Integer timeToLiveSeconds) throws Exception {
		try {
			...
			myCache.put(new Element(key, value, NewEHCacheConfig.ETERNAL, NewEHCacheConfig.TIMETOIDLESECONDS, timeToLiveSeconds));
			return true;
		} catch (Exception e) {
			throw new Exception("set cache " + cacheName + " failed!!!");
		}
