package com.mkst.mini.systemplus.common.utils;

import com.mkst.mini.systemplus.common.annotation.Excel;
import com.mkst.mini.systemplus.common.annotation.Excel.Type;
...
import com.mkst.mini.systemplus.common.utils.reflect.ReflectUtils;
        ...
        try
        {
            ...
            if (cell != null)
            {
                if (cell.getCellTypeEnum() == CellType.NUMERIC)
                {
                    ...
                    {
                        val = DateUtil.getJavaDate((Double) val); // POI Excel_bak 日期格式转换
                    }
                    else
                    {
                        if ((Double) val % 1 > 0)
